...
import { CommentExt, Content, IpfsHash, Post, PostExtension, PostHistoryRecord, PostId, PostUpdate, Profile, ProfileHistoryRecord, ProfileUpdate, Reaction, ReactionId, ReactionKind, Role, RoleId, RoleUpdate, ScoringAction, SocialAccount, Space, SpaceForRoles, SpaceHistoryRecord, SpaceId, SpacePermission, SpacePermissionSet, SpacePermissions, SpacePermissionsContext, SpaceUpdate, User, WhoAndWhen } from '@subsocial/types/substrate/interfaces/subsocial';
